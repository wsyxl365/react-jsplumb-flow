...
const knightSpec = {
    ...
    beginDrag(props, monitor, component) {
         ...
         */
        return {
            id: `freedom_activity_${rand(1000,9999)}`,
            key: `key_freedom_activity_${rand(1000,9999)}`,
...
class FreedomActivity extends Component{
    render() {
        ...
        return connectDragSource(
            ...
            >
                <Row>
                    <Col span={6} offset={5}>
                        <div className="faNodeImg"></div>
                    </Col>
                    <Col span={13}>
                        <div className="contentTitle">自由活动</div>
                    </Col>
                </Row>
            </div>
        )
...
export default FreedomActivity;