...
const knightSpec = {
    ...
    beginDrag(props, monitor, component) {
         ...
         */
        return {
            id: `outer_child_flow_node_${rand(1000,9999)}`,
            key: `key_outer_child_flow_node_${rand(1000,9999)}`,
            type: "outerChildFlowNode",
            name: "外部子流程",
            width: 100,
            height: 60
        };
...
class OuterChildFlowNode extends Component{
    render() {
        ...
        return connectDragSource(
            ...
            >
                <Row>
                    <Col span={6} offset={5}>
                        <div className="ocfNodeImg"></div>
                    </Col>
                    <Col span={13}>
                        <div className="contentTitle">外部子流程</div>
                    </Col>
                </Row>
            </div>
        )
...
export default OuterChildFlowNode;