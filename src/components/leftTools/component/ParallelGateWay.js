...
const knightSpec = {
    ...
    beginDrag(props, monitor, component) {
         ...
         */
        return {
            id: `parallel_gateway_${Util.randHash()}`,
            key: `key_parallel_gateway_${Util.randHash()}`,
            type: proConfig.nodeFlowType.parallelGateway,
            width: 60,
            height: 60,
            name: "并行网关",
            documentation: ""
    ...
    render() {
        ...
        return connectDragSource(
            ...
            >
                <Row>
                    <Col span={6} offset={5}>
                        <div className="gatewayNodeImg"><Icon className={"img-icon"} type="plus" /></div>
                    </Col>
                    <Col span={13}>
                        <div className="contentTitle">并行网关</div>
                    </Col>
                </Row>
            </div>
        )
