...
const knightSpec = {
    ...
    beginDrag(props, monitor, component) {
         ...
         */
        return {
            id: `pool_lane_dir_${Util.randHash()}`,
            key: `key_pool_lane_dir_${Util.randHash()}`,
            type: proConfig.nodeFlowType.poolLaneDirection,
            width: 200,
            height: 600,
            name: "纵向泳道",
            documentation: ""
    ...
    render() {
        ...
        return connectDragSource(
            ...
            >
                <Row>
                    <Col span={6} offset={5}>
                        <div className="pool-lane-dir-node-img"></div>
                    </Col>
                    <Col span={13}>
                        <div className="contentTitle">纵向泳道</div>
                    </Col>
                </Row>
            </div>
        )
