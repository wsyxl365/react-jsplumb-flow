...
const knightSpec = {
    ...
    beginDrag(props, monitor, component) {
         ...
         */
        return {
            id: `pool_lane_ori_${Util.randHash()}`,
            key: `key_pool_lane_ori_${Util.randHash()}`,
            type: proConfig.nodeFlowType.poolLaneOrientation,
            width: 1000,
            height: 200,
            name: "横向泳道",
            documentation: ""
...
class PoolLaneOrientation extends Component{
    render() {
        ...
        return connectDragSource(
            ...
            >
                <Row>
                    <Col span={6} offset={5}>
                        <div className="pool-lane-ori-node-img"></div>
                    </Col>
                    <Col span={13}>
                        <div className="contentTitle">横向泳道</div>
                    </Col>
                </Row>
            </div>
        )
...
export default PoolLaneOrientation;